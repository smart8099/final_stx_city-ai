...
</svg>`;function y(r,e){const t=/\*\*(.+?)\*\*|\[([^\]]+)\]\((https?:\/\/[^)]+)\)|(https?:\/\/\S+)/g;let n=0,i;for(;(i=t.exec(r))!==null;){if(i.index>n&&e.appendChild(document.createTextNode(r.slice(n,i.index))),i[1]!==void 0){const s=document.createElement("strong");s.textContent=i[1],e.appendChild(s)}else if(i[2]!==void 0){const s=document.createElement("a");s.href=i[3],s.textContent=i[2],s.target="_blank",s.rel="noopener noreferrer",e.appendChild(s)}else{const s=document.createElement("a");s.href=i[4],s.textContent=i[4],s.target="_blank",s.rel="noopener noreferrer",e.appendChild(s)}n=t.lastIndex}n<r.length&&e.appendChild(document.createTextNode(r.slice(n)))}function w(r){const e=document.createDocumentFragment(),t=r.split(`
`);for(let n=0;n<t.length;n++)n>0&&e.appendChild(document.createElement("br")),y(t[n],e);return e}class E{constructor(e,t){this.isOpen=!1,this.currentStreamEl=null,this.currentStreamText="",this.onSend=null,this.onNewConversation=null,this.opts=t;const n=t.position||"bottom-right";e.setAttribute("data-pos",n),this.shadow=e.attachShadow({mode:"open"}),this._build(),t.autoOpen&&this._open()}setOnSend(e){this.onSend=e}setOnNewConversation(e){this.onNewConversation=e}appendUserMessage(e){const t=this._msgEl("user");t.textContent=e,this.messagesContainer.appendChild(t),this._scrollToBottom()}startAssistantMessage(){const e=this._msgEl("assistant");e.classList.add("streaming"),this.messagesContainer.appendChild(e),this.currentStreamEl=e,this.currentStreamText="",this._scrollToBottom()}appendToken(e){this.currentStreamEl||this.startAssistantMessage(),this.currentStreamText+=e,this.currentStreamEl.textContent=this.currentStreamText,this._scrollToBottom()}finalizeMessage(e){if(this.currentStreamEl){for(this.currentStreamEl.classList.remove("streaming");this.currentStreamEl.firstChild;)this.currentStreamEl.removeChild(this.currentStreamEl.firstChild);if(this.currentStreamEl.appendChild(w(this.currentStreamText)),this.currentStreamText="",e.length>0){const t=document.createElement("div");t.className="sources",e.forEach(n=>{const i=document.createElement("a");i.href=n.url,i.textContent=n.title||n.url,i.target="_blank",i.rel="noopener noreferrer",t.appendChild(i)}),this.currentStreamEl.appendChild(t)}this.currentStreamEl=null}this.sendBtn.disabled=!1,this.input.disabled=!1,this.input.focus()}showResolutionCheck(e){const t=this._msgEl("assistant"),n=document.createElement("span");n.textContent="Was your question resolved?",t.appendChild(n);const i=document.createElement("div");i.className="action-buttons";const s=document.createElement("button");s.className="action-btn primary",s.textContent="✓ Yes";const o=document.createElement("button");o.className="action-btn secondary",o.textContent="✗ No";const a=()=>{s.disabled=!0,o.disabled=!0};s.addEventListener("click",()=>{a(),e(!0)}),o.addEventListener("click",()=>{a(),e(!1)}),i.appendChild(s),i.appendChild(o),t.appendChild(i),this.messagesContainer.appendChild(t),this._scrollToBottom()}showEscalationOffer(e,t){const n=this._msgEl("assistant"),i=e?.name??"the relevant city department",s=document.createElement("span");s.textContent=`It looks like your question may need more help. Would you like ${i} to reach out to you directly?`,n.appendChild(s);const o=document.createElement("div");o.className="action-buttons";const a=document.createElement("button");a.className="action-btn primary",a.textContent="Yes, contact me";const d=document.createElement("button");d.className="action-btn secondary",d.textContent="No, thanks";const l=()=>{a.disabled=!0,d.disabled=!0};a.addEventListener("click",()=>{l(),t()}),d.addEventListener("click",()=>{l()}),o.appendChild(a),o.appendChild(d),n.appendChild(o),this.messagesContainer.appendChild(n),this._scrollToBottom()}showContactForm(e){const t=this._msgEl("assistant"),n=document.createElement("span");n.textContent="Please provide your contact details and a representative will reach out within 24 hours.",t.appendChild(n);const i=document.createElement("div");i.className="contact-form";const s=document.createElement("input");s.type="tel",s.className="contact-input",s.placeholder="Phone number";const o=document.createElement("input");o.type="email",o.className="contact-input",o.placeholder="Email address";const a=document.createElement("button");a.className="action-btn primary",a.textContent="Submit",a.addEventListener("click",()=>{const d=s.value.trim(),l=o.value.trim();!d||!l||(a.disabled=!0,s.disabled=!0,o.disabled=!0,e(d,l))}),i.appendChild(s),i.appendChild(o),i.appendChild(a),t.appendChild(i),this.messagesContainer.appendChild(t),this._scrollToBottom()}showSystemMessage(e){const t=document.createElement("div");t.className="system-msg",t.textContent=e,this.messagesContainer.appendChild(t),this._scrollToBottom()}showMoreQuestionsCheck(e){const t=this._msgEl("assistant"),n=document.createElement("span");n.textContent="Do you have any more questions?",t.appendChild(n);const i=document.createElement("div");i.className="action-buttons";const s=document.createElement("button");s.className="action-btn primary",s.textContent="Yes";const o=document.createElement("button");o.className="action-btn secondary",o.textContent="No";const a=()=>{s.disabled=!0,o.disabled=!0};s.addEventListener("click",()=>{a(),e(!0)}),o.addEventListener("click",()=>{a(),e(!1)}),i.appendChild(s),i.appendChild(o),t.appendChild(i),this.messagesContainer.appendChild(t),this._scrollToBottom()}closeSession(e){this.input.disabled=!0,this.sendBtn.disabled=!0;const t=document.createElement("div");t.className="session-ended",t.textContent=e==="escalated"?"Your request has been submitted — the city will reach out within 24 hours.":"This session has ended.",this.messagesContainer.appendChild(t);const n=document.createElement("button");n.className="new-convo-btn",n.textContent="Start a new conversation",n.addEventListener("click",()=>{this.onNewConversation?.()}),this.messagesContainer.appendChild(n),this._scrollToBottom()}showError(e){const t=this._msgEl("assistant");t.textContent=`⚠️ ${e}`,t.style.color="#dc2626",this.messagesContainer.appendChild(t),this.currentStreamEl=null,this.sendBtn.disabled=!1,this.input.disabled=!1,this._scrollToBottom()}reset(){for(;this.messagesContainer.firstChild;)this.messagesContainer.removeChild(this.messagesContainer.firstChild);const e=document.createElement("div");e.id="greeting-area";const t=document.createElement("span");t.innerHTML=m.replace("viewBox",'id="greeting-icon" viewBox');const n=document.createElement("div");n.id="greeting-text",n.textContent=this.opts.greeting,e.appendChild(t),e.appendChild(n),this.messagesContainer.appendChild(e),this.currentStreamEl=null,this.currentStreamText="",this.input.disabled=!1,this.sendBtn.disabled=!1,this.input.value="",this.input.focus()}_build(){const e=document.createElement("style");e.textContent=b;const t=document.createElement("button");t.id="launcher",t.innerHTML=x,t.setAttribute("aria-label",`Open ${this.opts.cityName} chat assistant`),t.style.setProperty("--ca-brand",this.opts.brandColor),t.addEventListener("click",()=>this._toggle()),this.panel=document.createElement("div"),this.panel.id="panel",this.panel.classList.add("hidden"),this.panel.style.setProperty("--ca-brand",this.opts.brandColor);const n=document.createElement("div");n.id="header";const i=document.createElement("div");if(i.id="header-left",this.opts.logoUrl){const c=document.createElement("img");c.id="header-logo",c.src=this.opts.logoUrl,c.alt="Logo",i.appendChild(c)}const s=document.createElement("div");s.id="header-text";const o=document.createElement("span");o.id="header-title",o.textContent=this.opts.cityName;const a=document.createElement("span");a.id="header-subtitle",a.textContent="Ask about city services",s.appendChild(o),s.appendChild(a),i.appendChild(s);const d=document.createElement("div");d.id="header-right";const l=document.createElement("button");l.id="close-btn",l.textContent="✕",l.setAttribute("aria-label","Close chat"),l.addEventListener("click",()=>this._close()),d.appendChild(l),n.appendChild(i),n.appendChild(d),this.messagesContainer=document.createElement("div"),this.messagesContainer.id="messages",this.messagesContainer.setAttribute("role","log"),this.messagesContainer.setAttribute("aria-live","polite");const h=document.createElement("div");h.id="greeting-area";const f=document.createElement("span");f.innerHTML=m.replace("viewBox",'id="greeting-icon" viewBox');const u=document.createElement("div");u.id="greeting-text",u.textContent=this.opts.greeting,h.appendChild(f),h.appendChild(u),this.messagesContainer.appendChild(h);const p=document.createElement("div");p.id="input-row",this.input=document.createElement("textarea"),this.input.id="input",this.input.placeholder="Type your question...",this.input.rows=1,this.input.setAttribute("aria-label","Chat message"),this.input.addEventListener("keydown",c=>{c.key==="Enter"&&!c.shiftKey&&(c.preventDefault(),this._submitInput())}),this.sendBtn=document.createElement("button"),this.sendBtn.id="send-btn",this.sendBtn.innerHTML=C,this.sendBtn.setAttribute("aria-label","Send message"),this.sendBtn.addEventListener("click",()=>this._submitInput()),p.appendChild(this.input),p.appendChild(this.sendBtn),this.panel.appendChild(n),this.panel.appendChild(this.messagesContainer),this.panel.appendChild(p),this.shadow.appendChild(e),this.shadow.appendChild(t),this.shadow.appendChild(this.panel)}_submitInput(){const e=this.input.value.trim();!e||this.sendBtn.disabled||(this.input.value="",this.sendBtn.disabled=!0,this.input.disabled=!0,this.onSend?.(e))}_toggle(){this.isOpen?this._close():this._open()}_open(){this.isOpen=!0,this.panel.classList.remove("hidden"),this.input.focus()}_close(){this.isOpen=!1,this.panel.classList.add("hidden")}_msgEl(e){const t=document.createElement("div");return t.className=`msg ${e}`,t}_scrollToBottom(){this.messagesContainer.scrollTop=this.messagesContainer.scrollHeight}}async function v(r,e){const t=`${r}/api/tenants/${encodeURIComponent(e)}`,n=await fetch(t);if(!n.ok)throw new Error(`Failed to load tenant config for "${e}": HTTP ${n.status}`);return n.json()}function k(){return g()}function _(){return g()}function g(){return typeof crypto<"u"&&crypto.randomUUID?crypto.randomUUID():"xxxx-xxxx-4xxx-yxxx".replace(/[xy]/g,r=>{const e=Math.random()*16|0;return(r==="x"?e:e&3|8).toString(16)})}const S=1e3,T=3e4,N=6;class B{constructor(e){this.ws=null,this.reconnectAttempts=0,this.reconnectTimer=null,this.isAuthed=!1,this.messageQueue=[],this.destroyed=!1,this.options=e,this._connect()}send(e){const t=JSON.stringify({type:"message",content:e});this.isAuthed&&this.ws?.readyState===WebSocket.OPEN?this.ws.send(t):this.messageQueue.push(t)}sendFrame(e){this.isAuthed&&this.ws?.readyState===WebSocket.OPEN&&this.ws.send(JSON.stringify(e))}destroy(){this.destroyed=!0,this.reconnectTimer!==null&&clearTimeout(this.reconnectTimer),this.ws?.close()}_connect(){this.destroyed||(this.ws=new WebSocket(this.options.wsUrl),this.isAuthed=!1,this.ws.onopen=()=>{this.reconnectAttempts=0,this.ws.send(JSON.stringify({type:"auth",api_key:this.options.apiKey,session_id:this.options.sessionId}))},this.ws.onmessage=e=>{let t;try{t=JSON.parse(e.data)}catch{return}if(t.type==="auth_ok"){for(this.isAuthed=!0,this.options.onReady?.();this.messageQueue.length>0;){const n=this.messageQueue.shift();n&&this.ws.send(n)}return}t.type==="token"?this.options.onToken(t.token):t.type==="done"?this.options.onDone(t.sources):t.type==="resolution_check"?this.options.onResolutionCheck?.():t.type==="more_questions_check"?this.options.onMoreQuestionsCheck?.():t.type==="system_message"?this.options.onSystemMessage?.(t.content):t.type==="escalation_offer"?this.options.onEscalationOffer?.(t.department):t.type==="contact_form"?this.options.onContactForm?.():t.type==="session_closed"?this.options.onSessionClosed?.(t.reason):t.type==="error"&&this.options.onError(t.message)},this.ws.onerror=()=>{},this.ws.onclose=e=>{if(!this.destroyed){if(e.code===4001){this.options.onError("Authentication failed. Check your API key.");return}e.code!==1e3&&this._scheduleReconnect()}})}_scheduleReconnect(){if(this.reconnectAttempts>=N){this.options.onError("Connection lost. Please refresh the page.");return}const e=Math.min(S*Math.pow(2,this.reconnectAttempts),T);this.reconnectAttempts++,this.reconnectTimer=setTimeout(()=>this._connect(),e)}}function A(r){return r.replace(/^http/,"ws")}class M{constructor(e){this.config=null,this.ui=null,this.wsClient=null,this.options=e,this.sessionId=_(),this.host=document.createElement("div"),this.host.id="cityassist-widget-host",document.body.appendChild(this.host)}async init(){try{this.config=await v(this.options.apiUrl,this.options.tenantSlug)}catch(o){console.error("[CityAssist] Failed to load tenant config:",o);return}const e=this.config.city_name||this.config.name,t=this.config.brand_color??"#1a56db",n=this.config.logo_url??"",i=this.config.greeting??"Hi! Ask me anything about city services.";this.ui=new E(this.host,{brandColor:t,cityName:e,logoUrl:n,greeting:i,autoOpen:this.config.auto_open??!1,position:this.config.position??"bottom-right"});const s=this.options.wsUrl??`${A(this.options.apiUrl)}/api/ws`;this._mountWsClient(s),this.ui.setOnNewConversation(()=>this._resetConversation(s))}_mountWsClient(e){this.wsClient=new B({wsUrl:e,apiKey:this.config.api_key,sessionId:this.sessionId,onToken:t=>this.ui.appendToken(t),onDone:t=>this.ui.finalizeMessage(t),onError:t=>this.ui.showError(t),onReady:()=>{},onSystemMessage:t=>{this.ui.showSystemMessage(t)},onResolutionCheck:()=>{this.ui.showResolutionCheck(t=>{this.wsClient.sendFrame({type:"resolution_response",resolved:t})})},onMoreQuestionsCheck:()=>{this.ui.showMoreQuestionsCheck(t=>{this.wsClient.sendFrame({type:"more_questions_response",hasMore:t})})},onEscalationOffer:t=>{this.ui.showEscalationOffer(t,()=>{this.wsClient.sendFrame({type:"escalation_accept"})})},onContactForm:()=>{this.ui.showContactForm((t,n)=>{this.wsClient.sendFrame({type:"contact_submit",phone:t,email:n})})},onSessionClosed:t=>{this.ui.closeSession(t)}}),this.ui.setOnSend(t=>{this.ui.appendUserMessage(t),this.ui.startAssistantMessage(),this.wsClient.send(t)})}_resetConversation(e){this.wsClient?.destroy(),this.sessionId=k(),this.ui.reset(),this._mountWsClient(e)}destroy(){this.wsClient?.destroy(),this.host.remove()}}(function(){const e=document.querySelectorAll("script[data-tenant]");if(e.length===0){console.warn('[CityAssist] No <script data-tenant="..."> tag found.');return}const t=e[e.length-1],n=t.getAttribute("data-tenant");if(!n){console.warn("[CityAssist] data-tenant attribute is empty.");return}const i=t.getAttribute("data-api-url")??"https://api.cityassist.ai",s=t.getAttribute("data-ws-url")||void 0,o=new M({tenantSlug:n,apiUrl:i,...s?{wsUrl:s}:{}}),a=()=>{o.init()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",a):a()})()})();
